...
from garmin_dashboard.domain.plan_models import CoachContext, PlanConstraints, PlanProposal, ValidatedPlan
from garmin_dashboard.ports.coach import CoachProvider
from garmin_dashboard.ports.storage import PlanStore
